...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      nav_contact: "联系方式",
      profile_name: "侯健",
      profile_title: "统计学博士 | 管理科学与工程博士后 | 初级统计师",
      profile_desc: "主要关注分位回归、鞍点逼近、混合效应建模等领域。",
      education_title: "求学经历",
      education_undergrad: "新疆财经大学 统计与信息学院 理学学士",
      education_master: "新疆财经大学 统计与数据科学学院 理学硕士",
      education_phd: "中国人民大学 统计学院 理学博士",
      work_title: "工作经历",
      work_period: "2026.7–至今",
      work_postdoc: "国防科技大学 博士后",
      research_title: "研究领域",
      ...
      contact_affiliation_value_2: "国防科技大学系统工程学院",
    ...
    en: {
      ...
      profile_title: "PhD in Statistics | Postdoctoral Fellow in Management Science and Engineering | Junior Statistician",
      profile_desc: "Research interests include quantile regression, saddlepoint approximation, and mixed-effects modeling.",
      education_title: "Education",
      education_undergrad: "B.S., College of Statistics and Information, Xinjiang University of Finance and Economics",
      education_master: "M.S., College of Statistics and Data Science, Xinjiang University of Finance and Economics",
      education_phd: "Ph.D., School of Statistics, Renmin University of China",
      work_title: "Work Experience",
      work_period: "2026.7–Present",
      work_postdoc: "Postdoctoral Fellow, National University of Defense Technology",
      ...
      contact_affiliation_value_2: "College of Systems Engineering, National University of Defense Technology",
